...
def get_data (path):
    ...
    X_train = data[0:170,2::]
    y_test = data[170:270,1]
    X_test = data[170:270,2::]
    X_train_bias = data[0:170,1::]
    X_train_bias[:0] = 1
    X_test_bias = data[170:270,1::]
    X_test_bias[:0] = 1    
...
if __name__=='__main__' :
    ...
    for i in range(no_of_iterations):
        X_test, X_test_bias, X_train, X_train_bias, y_test, y_train = get_data ("/data/Work_CSU/Course_Work/Dropbox/Sneha_share/Latest_assgn/Final/Heart/heart.data")
        p = Perceptron()
